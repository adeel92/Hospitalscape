...
namespace Isometric.Environment
{
    ...
    {
        [Serializable]
        private class MainServiceAreaClothInfo
        {
            public DataConsumable OrderType;
            public Sprite MainServiceAreaClothSprite;
        ...
        public PathNode WorkerServeNode => m_WorkerServeNode;
        [SerializeField] PathNode m_WorkerServeNode;
        ...
        [SerializeField] List<MainServiceAreaClothInfo> m_MainServiceAreaClothsInfo;
        ...
        [Header("---UI---")]
        [SerializeField] MainServiceCallWorkerUIController m_CallWorkerUIController;
        [SerializeField] MainServiceOrderUIController m_OrderUIController;
        ...
        [Header("---Main Service Area Clean Start---")]
        public UnityEvent OnMainServiceAreaCleanStart;

        [Header("---Main Service Area Clean Complete---")]
        public UnityEvent OnMainServiceAreaCleanComplete;
