...
{
    public class StationEngageOrderOut : MonoBehaviour
    {
        //---Setup---
        ...
        [SerializeField, Foldout(MetaSetupFoldOut)] DataConsumable m_OrderType;
        ...
        private void OnTaskStart(TaskTarget taskTarget)
        {
            ...
            {
                if (interactable.SendDataConsumable(m_OrderType, m_CostProperty))
                {
